...
@interface TGBookClassesController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation TGBookClassesController
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TGBookListViewController *foodVc=[[TGBookListViewController alloc] init];
    foodVc.bookDict=self.classListArr[indexPath.row];
...
-(void)requestNetWorkFoodClssify
{
    ...
    [AllReqestAPIManager getBookClassesClass:nil success:^(NSDictionary *json) {
