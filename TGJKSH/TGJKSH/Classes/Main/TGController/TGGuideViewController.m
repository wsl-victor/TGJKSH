...
#define btnH 35
#define btnW 140
@interface TGGuideViewController ()<UIScrollViewDelegate>
/**
 *  底部滚动图片
 */
 ...
 *  顶部图片滚动
 */
@property (nonatomic,strong)UIScrollView *topView;@end

@implementation TGGuideViewController
...
{
    TGTabBarViewController *pbsMainTabVc=[[TGTabBarViewController alloc] init];
